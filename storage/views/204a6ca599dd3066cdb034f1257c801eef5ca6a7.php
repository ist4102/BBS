...
<?php $__currentLoopData = $urlset->urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('fof-sitemap::url', ['url' => $url], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</urlset>
<?php /**PATH /www/wwwroot/bbs.ist4102.cloud/vendor/fof/sitemap/views/sitemap.blade.php ENDPATH**/ ?>